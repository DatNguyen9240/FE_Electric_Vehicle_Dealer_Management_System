...
const SlotList: React.FC = () => {
  ...
  const handleTimeSlotClick = (time: string) => {
    navigate(`/admin/bookings/station/${stationId}/charger/${chargerId}/book/${time}`);
  };
  ...
  return (
    <div className="p-6">
        ...
        <div className="mb-6">
          <button
            onClick={() => navigate(`/admin/bookings/station/${stationId}`)}
            className="flex items-center gap-2 text-blue-500 hover:text-blue-600 text-sm ms-5 mb-4"
          >
            <ArrowLeft size={15} />
            <span className="font-medium">Back to Chargers</span>
          </button>
